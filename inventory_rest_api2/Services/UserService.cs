...
namespace inventory_rest_api.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public User Create(User user, string password)
        {
            ...
            if (_context.Users.Any(x => x.UserEmail == user.UserEmail))
                throw new AppException("Useremail " + user.UserEmail + " is already taken");
        ...
        public void Update(User userParam, string password = null)
        {
            ...
            if (userParam.UserEmail != user.UserEmail)
            {
                ...
                if (_context.Users.Any(x => x.UserEmail == userParam.UserEmail))
                    throw new AppException("Useremail " + userParam.UserEmail + " is already taken");
            }
