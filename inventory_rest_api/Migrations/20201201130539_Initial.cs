    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalesMemoHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalesMemoHistories_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesMemoHistories_UserId",
                table: "SalesMemoHistories",
                column: "UserId");
