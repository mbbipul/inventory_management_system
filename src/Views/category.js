...
function Category(){
    ...
    const tabs = [
        {
            tab : "All Categories",
            tabPanel : <CollapsibleTable />
        },
        {
            tab : "Manage Category",
            tabPanel : "categoires list manage"
        }
    ]
    ...
    return(
        <div>
            ...
            <Fab onClick={() => setOpen(true)} style={{position : "absolute" , bottom :50,right:50}} color="primary" aria-label="add">
                <AddIcon />
            </Fab>
